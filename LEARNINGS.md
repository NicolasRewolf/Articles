...
>
> **Dernière digestion : 2026-08-25 — RETEX de performance.** Première digestion dont la matière vient du **terrain** (base `cooked`) et non de la production. Quatre règles promues directement, sans passage par ce journal, sur accord explicite de Nicolas : **LEARN-081** (qualifier la requête d'entrée sur l'état du chercheur, pas sur le volume — avec porte de sortie GO / NO-GO / actif d'autorité), **LEARN-082** (le plan H2/H3 part des clusters du Bloc B, la trame se lit en seconde passe), **LEARN-083** (vocabulaire réversible : nommer le persona écarté et le mot qui l'écarte), **LEARN-084** (Étape 5 — mesure M+3 depuis `cooked`, la boucle qui manquait). Trois contrôles ajoutés au lint. Détail, chiffres et arbitrages : [`LEARNINGS-archive.md` §Digestion 2026-08-25](LEARNINGS-archive.md).
> **Ce que cette digestion apprend sur la méthode** : le journal ne capturait que ce qui se voit pendant la fabrication. Rien dans le protocole ne regardait le résultat — d'où l'Étape 5, dont la sortie alimentera désormais ce fichier au même titre que les captures post-article. Trois constats du RETEX n'ont **pas** été promus et attendent un arbitrage : le quota d'ancrage local (LEARN-042, appliqué 3 à 18 fois pour zéro impression géolocalisée), l'extension de l'inventaire anti-cannibalisation aux pages d'expertise, et le format de désambiguïsation « A ou B » (à tester sur un article avant toute règle).
>
> **Digestion précédente : 2026-08-14** (avant l'article #14, cour criminelle départementale). Promus : **LEARN-058**, **LEARN-059 + 070** (fusionnés en typologie de l'angle mort), **LEARN-060**, **LEARN-061**, **LEARN-062 + 069 + 075** (fusionnés en discipline de version Légifrance), **LEARN-071**, **LEARN-072**, **LEARN-073** (correction du plafond de push Wix). Archivés : **LEARN-055**, **LEARN-068**, **LEARN-074**.
